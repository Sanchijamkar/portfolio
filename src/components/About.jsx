...
import AboutImage from '../assets/heroo.png'
      ...
      <div className='container mx-auto px-8 md:px-16 lg:px-24'>
        ...
        <div className='flex flex-col md:flex-row items-center md:space-x-12'>
          ...
          <div className='flex-1'>
            <p className='text-lg mb-8'>I'm a passionate Full Stack Developer and UI/UX Designer with a focus on building modern and responsive web applications. With a strong foundation in both Frontend and Backend technologies as well as web designing. I strive to create seamless and efficient user experiences.</p>
            <div className='space-y-4'>
              ...
              <div className='flex items-center'>
                <label htmlFor="htmlandcss" className='w-2/12'>UI/UX Designing</label>
                <div className='grow bg-gray-800 rounded-full h-2.5'>
                  <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 rounded-full transform transition-transform duration-300 hover:scale-105 w-10/12'></div>
                </div>
              </div>
